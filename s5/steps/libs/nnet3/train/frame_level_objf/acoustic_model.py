...
def generate_egs(data, alidir, egs_dir,
    ...
    """
    print("""steps/nnet3/get_egs.sh {egs_opts} \
                --cmd "{command}" \
                --cmvn-opts "{cmvn_opts}" \
                ...
                --generate-egs-scp {generate_egs_scp_flag}
                --srand {srand} \
                {data} {alidir} {egs_dir}""".format(command=run_opts.egs_command,
